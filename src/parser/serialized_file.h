...
struct ObjectInfo {
    ...
    int32_t type_id = 0;
    int32_t class_id = 0;
    std::string source_file; // اسم الملف الأصلي القادم منه
};
...
enum UnityClassID {
    ...
    ClassID_Mesh = 43,
    ClassID_TextAsset = 49,
    ClassID_AudioClip = 83,
...
public:
    ...
    bool parse(const uint8_t* raw_data, size_t raw_size, const std::string& name = "");
};
